...
public class SpawnDynamicObstacles : MonoBehaviour {
	...
	void Start () {
		...
		for(int i = 0; i < numCubes; i++){
			SpawnSquareDynRandObstacles();
		}

		/*Generate Spheres*/
		for(int i = 0; i < numSpheres; i++){
			SpawnSphereDynRandObstacles();
		}
	...
	*/
	public void SpawnSphereDynRandObstacles(){
	...
	*/
	public void SpawnSquareDynRandObstacles(){
